...
public class PaintJob {
    ...
    public static int getBucketCount(double width,double height, double areaPerBucket) {
        ...
        if ((width <= 0) || (height <= 0) || (areaPerBucket <= 0))  {
            ...
            double a = (width * height) / areaPerBucket;
    ...
    if ((width <= 0) || (height <= 0) || (areaPerBucket <= 0) || (extraBuckets <0) ) {
        ...
        double a = (width * height) / areaPerBucket;
        return (int)(Math.ceil(a - (extraBuckets)));
    }
    ...
    public static void main(String[] args) {
        //getBucketCount()
        int a =0;
        a= getBucketCount(-3.4, 2.1, 1.5, 2); // r -1
        System.out.println(a);
        a= getBucketCount(3.4, 2.1, 1.5, 2); // r 3
        System.out.println(a);
        a= getBucketCount(2.75, 3.25, 2.5, 1); //r 3
        System.out.println(a);
        a= getBucketCount(-3.4, 2.1, 1.5);
        System.out.println(a);
        a= getBucketCount(3.4, 2.1, 1.5); // r5
        System.out.println(a);
        a = getBucketCount(7.25, 4.3, 2.35); // r14
        System.out.println(a);
        a= getBucketCount(3.4, 1.5);
        System.out.println(a);

        a= getBucketCount(6.26, 2.2);
        System.out.println(a);
        a = getBucketCount(3.26, 0.75);
        System.out.println(a);
        a= getBucketCount(.75, .75, .5, 0); // r 2
        System.out.println(a);
