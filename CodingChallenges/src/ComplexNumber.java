...
public class ComplexNumber {
    ...
    public void add (ComplexNumber parm){
        this.imaginary =this.imaginary+ parm.getImaginary();
        this.real =this.real + parm.getReal();
    }
    ...
    public void subtract (ComplexNumber parm){
        this.imaginary =this.imaginary- parm.getImaginary();
        this.real =this.real- parm.getReal();
    }
